                ...
                <div className="flex flex-wrap gap-1.5 mt-1.5">
                  {revisionesRevisadas.map((r) => (
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-lg bg-surface-container-high px-2.5 py-1 text-[10px] font-bold text-on-surface transition-colors hover:bg-surface-container-highest"
                    >
        ...
        <div className="shrink-0 border-t border-outline-variant/30 bg-surface px-6 py-4">
          <div className="max-w-3xl mx-auto flex gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-xl bg-surface-container-high px-5 py-3 text-sm font-bold text-on-surface transition-colors hover:bg-surface-container-highest disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="fixed inset-0 z-50 flex flex-col bg-surface overflow-hidden animate-in slide-in-from-right-full duration-300">
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="max-w-3xl mx-auto px-6 py-8 space-y-10">
                ...
                <section>
                  ...
                  {!c.general && !c.roles && (
                    <p className="mt-6 text-sm text-tertiary italic">Esta revisión no tiene comentarios del revisor.</p>
                  )}
                </section>
              </div>
            </div>
            ...
            <div className="shrink-0 border-t border-outline-variant/30 bg-surface px-6 py-4">
              <div className="max-w-3xl mx-auto">
                <button
                  onClick={() => setSelectedRevision(null)}
                  className="w-full rounded-xl bg-surface-container-high px-4 py-3 text-sm font-bold text-on-surface hover:bg-surface-container-highest transition-colors"
                >
                  Cerrar
                </button>
              </div>
